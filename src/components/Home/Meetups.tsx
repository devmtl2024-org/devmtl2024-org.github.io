...
function Meetups() {
  return (
    <section className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 h-96">
      ...
      {/* Texte à droite */}
      <div className="bg-gradient-to-b from-primary-dark to-primary/80 flex flex-col justify-center px-8 text-white">
